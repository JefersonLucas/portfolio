...
const Experience: React.FC = () => {
	...
	return (
		<S.Container aria-label="Experiência" id="experiencia">
			<Subtitle color={theme.colors.g3}>Experiência</Subtitle>

			<S.Content>
				<S.Description>
					Trabalho com desenvolvimento <strong>web</strong> e{' '}
					<strong>mobile</strong>, desde pequenos projetos passando por grandes{' '}
					<strong>aplicações</strong>, <strong>landing pages</strong>,{' '}
